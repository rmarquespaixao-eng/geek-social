...
2. **Lista de amigos melhorada** — UX win rápido
3. **Comunidades: notificações + cross-post** — completar loop social das comunidades

### Médio prazo
4. **Feature flags** — habilitador de features futuras com rollout gradual
5. **Comunidades: chat próprio + eventos da comunidade**
