...
export default function Request() {
  return (
    <div className="not-prose">
      ...
      <tbody>
        <tr><td className="font-mono">email</td><td className="font-mono text-xs">string (email)</td><td>sim</td><td></td></tr>
        <tr><td className="font-mono">password</td><td className="font-mono text-xs">string</td><td>sim</td><td></td></tr>
      </tbody>
    </table>
    </div>
  )
