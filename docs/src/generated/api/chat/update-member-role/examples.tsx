...
const CURL = `curl -X PATCH 'http://localhost:3003/chat/groups/{id}/members/{userId}/role' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/chat/groups/{id}/members/{userId}/role', {
  method: 'PATCH',
  headers: {
