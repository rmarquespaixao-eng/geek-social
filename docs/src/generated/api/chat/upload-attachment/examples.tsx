...
const CURL = `curl -X POST 'http://localhost:3003/chat/conversations/{id}/attachments' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/chat/conversations/{id}/attachments', {
  method: 'POST',
  headers: {
