...
const CURL = `curl -X DELETE 'https://geeksocialapi.homelab-cloud.com/communities/{id}/members/me' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN'`

const NODE = `await fetch('https://geeksocialapi.homelab-cloud.com/communities/{id}/members/me', {
  method: 'DELETE',
