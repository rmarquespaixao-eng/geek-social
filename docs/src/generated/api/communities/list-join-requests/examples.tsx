...
const CURL = `curl -X GET 'https://geeksocialapi.homelab-cloud.com/communities/{id}/join-requests' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN'`

const NODE = `await fetch('https://geeksocialapi.homelab-cloud.com/communities/{id}/join-requests', {
  method: 'GET',
