...
const CURL = `curl -X GET 'https://geeksocialapi.homelab-cloud.com/communities/me/owned' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN'`

const NODE = `await fetch('https://geeksocialapi.homelab-cloud.com/communities/me/owned', {
  method: 'GET',
