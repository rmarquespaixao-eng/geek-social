...
const CURL = `curl -X POST 'https://geeksocialapi.homelab-cloud.com/events/{id}/invites' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -H 'Content-Type: application/json' \\
  -d '{"userId":"uuid-do-usuario"}'`

const NODE = `await fetch('https://geeksocialapi.homelab-cloud.com/events/{id}/invites', {
  method: 'POST',
