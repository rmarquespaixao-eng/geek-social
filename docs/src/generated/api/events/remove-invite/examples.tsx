...
const CURL = `curl -X DELETE 'https://geeksocialapi.homelab-cloud.com/events/{id}/invites/{userId}' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN'`

const NODE = `await fetch('https://geeksocialapi.homelab-cloud.com/events/{id}/invites/{userId}', {
  method: 'DELETE',
