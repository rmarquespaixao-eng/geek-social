...
const CURL = `curl -X DELETE 'http://localhost:3003/collections/{collectionId}/items/{itemId}' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/collections/{collectionId}/items/{itemId}', {
  method: 'DELETE',
  headers: {
