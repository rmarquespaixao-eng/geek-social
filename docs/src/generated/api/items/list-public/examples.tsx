...
const CURL = `curl -X GET 'http://localhost:3003/users/{userId}/collections/{collectionId}/items' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/users/{userId}/collections/{collectionId}/items', {
  method: 'GET',
  headers: {
