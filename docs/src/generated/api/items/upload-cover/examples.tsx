...
const CURL = `curl -X POST 'http://localhost:3003/collections/{collectionId}/items/{itemId}/cover' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/collections/{collectionId}/items/{itemId}/cover', {
  method: 'POST',
  headers: {
