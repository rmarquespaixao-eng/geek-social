...
export default function Request() {
  return (
    <div className="not-prose">
      ...
      <tbody>
        <tr><td className="font-mono">offerId</td><td className="font-mono text-xs">string (uuid)</td><td>sim</td><td></td></tr>
        <tr><td className="font-mono">score</td><td className="font-mono text-xs">integer</td><td>sim</td><td></td></tr>
      </tbody>
    </table>
    </div>
  )
