...
const CURL = `curl -X GET 'http://localhost:3003/integrations/steam/import/{batchId}/status' \\
  -H 'Content-Type: application/json' \\
  -H 'Authorization: Bearer SEU_ACCESS_TOKEN' \\
  -d '{}'`

const NODE = `await fetch('http://localhost:3003/integrations/steam/import/{batchId}/status', {
  method: 'GET',
  headers: {
