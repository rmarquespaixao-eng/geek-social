...
export default function Request() {
  return (
    <div className="not-prose">
      ...
      <tbody>
        <tr><td className="font-mono">showPresence</td><td className="font-mono text-xs">boolean</td><td>não</td><td></td></tr>
        <tr><td className="font-mono">showReadReceipts</td><td className="font-mono text-xs">boolean</td><td>não</td><td></td></tr>
      </tbody>
    </table>
    </div>
  )
