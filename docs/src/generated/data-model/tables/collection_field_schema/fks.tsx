  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tbody>
        <tr>
          <td className="font-mono">collection_id</td>
          <td className="font-mono">collections.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">field_definition_id</td>
          <td className="font-mono">field_definitions.id</td>
          <td>no action</td>
          <td>no action</td>
        </tr>
        </tbody>
