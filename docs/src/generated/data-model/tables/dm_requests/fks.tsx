  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tbody>
        <tr>
          <td className="font-mono">sender_id</td>
          <td className="font-mono">users.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">receiver_id</td>
          <td className="font-mono">users.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">conversation_id</td>
          <td className="font-mono">conversations.id</td>
          <td>set null</td>
          <td>no action</td>
        </tr>
        </tbody>
