  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tr>
          <td className="font-mono text-sm">field_key</td>
          <td className="font-mono text-xs">varchar</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">field_type</td>
          <td className="font-mono text-xs">enumcolumn</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">collection_type</td>
          <td className="font-mono text-xs">enumcolumn</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">select_options</td>
          <td className="font-mono text-xs">jsonb</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">is_system</td>
          <td className="font-mono text-xs">boolean</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">false</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">is_hidden</td>
          <td className="font-mono text-xs">boolean</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">false</td>
        </tr>
