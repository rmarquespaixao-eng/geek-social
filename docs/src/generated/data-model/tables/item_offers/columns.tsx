  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tr>
          <td className="font-mono text-sm">offerer_id</td>
          <td className="font-mono text-xs">uuid</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">offered_item_id</td>
          <td className="font-mono text-xs">uuid</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">offered_price</td>
          <td className="font-mono text-xs">numeric</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">message</td>
        ...
        <tr>
          <td className="font-mono text-sm">offerer_confirmed_at</td>
          <td className="font-mono text-xs">timestamp</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">owner_confirmed_at</td>
          <td className="font-mono text-xs">timestamp</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">listing_id</td>
          <td className="font-mono text-xs">uuid</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
