    ...
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tr>
          ...
          <td className="font-mono">items.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">owner_id</td>
          <td className="font-mono">users.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">offerer_id</td>
          <td className="font-mono">users.id</td>
          <td>cascade</td>
          <td>no action</td>
        </tr>
        <tr>
          <td className="font-mono">offered_item_id</td>
          <td className="font-mono">items.id</td>
          <td>set null</td>
          <td>no action</td>
        </tr>
        <tr>
          ...
          <td className="font-mono">listings.id</td>
          <td>set null</td>
          <td>no action</td>
        </tr>
        </tbody>
