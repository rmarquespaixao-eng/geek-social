  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tbody>
        <tr>
          <td className="font-mono text-sm">message_reactions_unique</td>
          <td>sim</td>
          <td className="font-mono">message_id, user_id, emoji</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">message_reactions_message_idx</td>
          <td>não</td>
          <td className="font-mono">message_id</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        </tbody>
      </table>
