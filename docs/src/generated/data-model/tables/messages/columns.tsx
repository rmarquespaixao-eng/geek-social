  ...
  return (
    <div className="not-prose">
      <table className="w-full text-sm my-4">
        ...
        <tr>
          <td className="font-mono text-sm">content</td>
          <td className="font-mono text-xs">text</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">reply_to_id</td>
          <td className="font-mono text-xs">uuid</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">call_metadata</td>
          <td className="font-mono text-xs">jsonb</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">is_temporary</td>
          <td className="font-mono text-xs">boolean</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">false</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">temporary_event</td>
          <td className="font-mono text-xs">jsonb</td>
          <td>NULL ok</td>
          <td className="font-mono text-xs">—</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">hidden_for_user_ids</td>
          <td className="font-mono text-xs">jsonb</td>
          <td>NOT NULL</td>
          <td className="font-mono text-xs">[]</td>
        </tr>
        <tr>
          <td className="font-mono text-sm">deleted_at</td>
