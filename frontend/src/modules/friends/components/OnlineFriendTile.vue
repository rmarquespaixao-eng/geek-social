...
<template>
  <div
    class="group relative flex flex-col items-center gap-2 p-3 rounded-xl bg-[#1e2038] border border-[#252640] hover:border-[#22c55e]/40 cursor-pointer transition-all hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#22c55e]/10"
    @click="viewProfile"
  >
    <div class="relative">
      <AppAvatar :src="friend.avatarUrl" :name="friend.displayName" :size="56" />
      <span class="absolute bottom-0 right-0 h-3.5 w-3.5 rounded-full border-[2.5px] border-[#1e2038] bg-[#22c55e] shadow-[0_0_8px_rgba(34,197,94,0.6)]" />
    </div>
